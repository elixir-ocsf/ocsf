defmodule OCSF.StatusDetailTest do
  ...
  test "values/1 returns well-known strings for Authentication (3002)" do
  ...
  test "values/1 returns empty for unknown class" do
    assert StatusDetail.values(9999) == []
  end

  test "valid?/2 checks known values" do
